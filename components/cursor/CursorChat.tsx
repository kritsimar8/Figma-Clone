...
const CursorChat = ({cursor, cursorState, setCursorState,updateMyPresence}: CursorChatProps) => {
  ...
  return (
    <div className='absolute top-0 left-0' style={{ transform:`translatex(${cursor.x}px) translatey(${cursor.y}px)`}}>
        ...
        <>
          <CursorSVG color="#000"/>
          <div className="absolute left-2 top-5 bg-blue-500 px-4 py-2 text-sm text-white leading-relaxed rounded-[20px]" onKeyUp={(e)=>e.stopPropagation()}>
            ...
            <input
              ...
              placeholder={cursorState.previousMessage ? '': 'Type a message...'} maxLength={50}
            />
          </div>
        </>
